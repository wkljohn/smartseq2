...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/smartseq2/usage](https://nf-co.re/smartseq2/usage)
...
```bash
nextflow run nf-core/smartseq2 --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/smartseq2`](https://hub.docker.com/r/nfcore/smartseq2/)
* `singularity`
